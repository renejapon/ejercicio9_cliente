...
function insertSliders(){
    ...
    for(var i=1;i<=num_sliders;i++){
        html_slider += '<div class="swiper-slide"><img src="media/img/slider_modelo_00'+i+'.jpg" class="swiper-lazy"></div>'
    }
...
function setHeader(){
    ...
    codeHeader +='    <a class="navbar-brand" href="index.html">Stradivarius</a>';
